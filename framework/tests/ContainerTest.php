...
use SydVic\Framework\Container\Container;
use SydVic\Framework\Container\ContainerException;
...
class ContainerTest extends TestCase
{
    ...
    public function a_service_can_be_retrieved_from_the_container(): void
    {
        ...
        $this->assertInstanceOf(DependantClass::class, $container->get('dependent-class'));
    }
